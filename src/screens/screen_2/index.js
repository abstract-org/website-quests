        ...
        <div className={styles.screen}>
            <div className="container">
                <div className={styles.divider_1}>
                    <Fade direction="down"><Divider size="middle"/></Fade>
                </div>
                ...
                <div className={"title_1 white_text " + styles.mobile_title}>
                    <Fade direction="up">{content.metadata.block_2__scroller_fragment_1}</Fade>
                </div>
                <div className={styles.mobile_info_block}>
                    <div className="title_3 white_text">
                        <Fade>{content.metadata.block_2__point_1_header}</Fade>
                    </div>
                    <div className={"small_text white_text " + styles.research_text}>
                        <Fade>{content.metadata.block_2__point_1_description}</Fade>
                    </div>
                </div>
                <div className={styles.mobile_info_block}>
                    <div className="title_3 white_text">
                        <Fade>{content.metadata.block_2__point_2_header}</Fade>
                    </div>
                    <div className={"small_text white_text " + styles.research_text}>
                        <Fade>{content.metadata.block_2__point_2_description}</Fade>
                    </div>
                </div>
                <div className={styles.mobile_info_block}>
                    <div className="title_3 white_text">
                        <Fade>{content.metadata.block_2__point_3_header}</Fade>
                    </div>
                    <div className={"small_text white_text " + styles.research_text}>
                        <Fade>{content.metadata.block_2__point_3_description}</Fade>
                    </div>
                </div>
